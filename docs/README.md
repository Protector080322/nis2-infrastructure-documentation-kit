...
| **Scripts** | Infrastructure Assessmenting & Automation | [Scripts README](../scripts/README.md) |
...
2. **Perform an Assessment:** Use the [Assessment Script](../scripts/README.md#1-linuxkmu-infra-assessmentsh) to assess your current environment.
...
- Following a security incident or assessment.
