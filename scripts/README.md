...
This directory contains automation scripts for infrastructure analysis, auditing, and documentation.

## Available Scripts

### 1. `linux/kmu-infra-audit.sh`
A basic security and system audit script for Linux hosts. It collects information about:
...
**Usage:**
```bash
chmod +x linux/kmu-infra-audit.sh
./linux/kmu-infra-audit.sh
```
